---
name: "source-command-pair-examples"
description: "Migrated source command `pair-examples`"
---

# source-command-pair-examples

Use this skill when the user asks to run the migrated source command `pair-examples`.
...
Codex-flow pair --template <template>
```
