...
description: "Migrated source command `github-pr-manager`"
---

# source-command-github-pr-manager

Use this skill when the user asks to run the migrated source command `github-pr-manager`.
...
mcp__github__create_pull_request {
  owner: "ruvnet",
  repo: "ruv-FANN",
  title: "Integration: Codex-flow and ruv-swarm",
  head: "integration/Codex-flow-ruv-swarm",
  base: "main",
...
mcp__github__merge_pull_request {
  ...
  pull_number: 54,
  merge_method: "squash",
  commit_title: "feat: Complete Codex-flow and ruv-swarm integration",
