...
description: "Migrated source command `github-repo-architect`"
---

# source-command-github-repo-architect

Use this skill when the user asks to run the migrated source command `github-repo-architect`.
...
mcp__github__create_repository {
  ...
  description: "Standardized template for Codex projects with ruv-swarm integration",
  private: false,
  autoInit: true
}
...
mcp__github__push_files {
  ...
  files: [
    ...
    {
      path: ".Codex/commands/sparc/sparc-modes.md", 
    ...
    },
    {
      ...
      content: JSON.stringify({
        name: "Codex-project-template",
        version: "1.0.0",
        description: "Codex project with ruv-swarm integration",
        engines: { node: ">=20.0.0" },
        dependencies: {
          "ruv-swarm": "^1.0.11"
        }
    ...
    {
      path: "README.md",
      content: `# Codex Project Template

## Quick Start
\`\`\`bash
npx Codex-flow init --sparc
npm install
npx Codex-flow start --ui
\`\`\`
...
See AGENTS.md for complete integration instructions.`
  ...
  message: "feat: Create standardized Codex project template with ruv-swarm integration"
}
```
...
[Single Message - Repository Architecture Review]:
  ...
  mcp__github__push_files {
    ...
    files: [
      {
        path: "Codex-flow/Codex-flow/.github/ISSUE_TEMPLATE/integration.yml",
        content: "[Integration issue template]"
      },
      {
        path: "Codex-flow/Codex-flow/.github/PULL_REQUEST_TEMPLATE.md",
        content: "[Standardized PR template]"
      },
      {
        path: "Codex-flow/Codex-flow/docs/ARCHITECTURE.md",
