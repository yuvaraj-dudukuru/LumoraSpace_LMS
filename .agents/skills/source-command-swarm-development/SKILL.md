---
name: "source-command-swarm-development"
description: "Migrated source command `swarm-development`"
---

# source-command-swarm-development

Use this skill when the user asks to run the migrated source command `swarm-development`.
