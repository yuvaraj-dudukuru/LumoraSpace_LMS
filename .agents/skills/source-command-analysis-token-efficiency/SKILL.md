...
description: "Migrated source command `analysis-token-efficiency`"
---

# source-command-analysis-token-efficiency

Use this skill when the user asks to run the migrated source command `analysis-token-efficiency`.
