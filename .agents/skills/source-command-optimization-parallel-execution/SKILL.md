...
description: "Migrated source command `optimization-parallel-execution`"
---

# source-command-optimization-parallel-execution

Use this skill when the user asks to run the migrated source command `optimization-parallel-execution`.
...
npx Codex-flow parallel "Build REST API" --max-agents 8
```
