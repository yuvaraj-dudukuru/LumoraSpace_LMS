---
name: "source-command-swarm-maintenance"
description: "Migrated source command `swarm-maintenance`"
---

# source-command-swarm-maintenance

Use this skill when the user asks to run the migrated source command `swarm-maintenance`.
