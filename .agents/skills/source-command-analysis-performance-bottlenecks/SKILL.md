...
description: "Migrated source command `analysis-performance-bottlenecks`"
---

# source-command-analysis-performance-bottlenecks

Use this skill when the user asks to run the migrated source command `analysis-performance-bottlenecks`.
