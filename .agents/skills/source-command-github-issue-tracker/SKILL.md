...
description: "Migrated source command `github-issue-tracker`"
---

# source-command-github-issue-tracker

Use this skill when the user asks to run the migrated source command `github-issue-tracker`.
...
mcp__github__create_issue {
  owner: "ruvnet",
  repo: "ruv-FANN",
  title: "Integration Review: Codex-flow and ruv-swarm complete integration",
...
[Single Message - Issue Lifecycle Management]:
  ...
  Bash(`gh issue create \
    ...
    --body "Resolve merge conflicts in integration/Codex-flow-ruv-swarm..." \
