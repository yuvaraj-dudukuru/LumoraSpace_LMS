---
name: "source-command-swarm-optimization"
description: "Migrated source command `swarm-optimization`"
---

# source-command-swarm-optimization

Use this skill when the user asks to run the migrated source command `swarm-optimization`.
