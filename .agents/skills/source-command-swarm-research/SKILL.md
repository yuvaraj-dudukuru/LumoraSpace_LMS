---
name: "source-command-swarm-research"
description: "Migrated source command `swarm-research`"
---

# source-command-swarm-research

Use this skill when the user asks to run the migrated source command `swarm-research`.
