...
description: "Migrated source command `hooks-pre-edit`"
---

# source-command-hooks-pre-edit

Use this skill when the user asks to run the migrated source command `hooks-pre-edit`.
...
```bash
npx Codex-flow hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
npx Codex-flow hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
npx Codex-flow hook pre-edit --file "path/to/file.js" --validate-syntax
```
