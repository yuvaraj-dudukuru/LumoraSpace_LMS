...
description: "Migrated source command `training-neural-patterns`"
---

# source-command-training-neural-patterns

Use this skill when the user asks to run the migrated source command `training-neural-patterns`.
...
- **Patterns**: `.Codex-flow/neural/patterns.json`
...
# Search patterns
npx Codex-flow neural patterns --action list -q "query"
