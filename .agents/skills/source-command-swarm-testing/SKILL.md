---
name: "source-command-swarm-testing"
description: "Migrated source command `swarm-testing`"
---

# source-command-swarm-testing

Use this skill when the user asks to run the migrated source command `swarm-testing`.
