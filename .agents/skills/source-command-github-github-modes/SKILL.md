...
description: "Migrated source command `github-github-modes`"
---

# source-command-github-github-modes

Use this skill when the user asks to run the migrated source command `github-github-modes`.
...
## Overview
This document describes all GitHub integration modes available in Codex-Flow with ruv-swarm coordination. Each mode is optimized for specific GitHub workflows and includes batch tool integration for maximum efficiency.
...
```bash
/github sync-coordinator "Synchronize Codex-flow and ruv-swarm packages, align versions, and update cross-dependencies"
```
