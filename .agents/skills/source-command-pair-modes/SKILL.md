---
name: "source-command-pair-modes"
description: "Migrated source command `pair-modes`"
---

# source-command-pair-modes

Use this skill when the user asks to run the migrated source command `pair-modes`.
...
### Usage
```bash
Codex-flow pair --start --mode switch [--interval <time>]
```
...
# Hour-long intervals
Codex-flow pair --start --mode switch --interval 1h
```
