...
description: "Migrated source command `optimization-auto-topology`"
---

# source-command-optimization-auto-topology

Use this skill when the user asks to run the migrated source command `optimization-auto-topology`.
...
```json
{
  "command": "npx Codex-flow hook pre-task --optimize-topology"
}
```
...
npx Codex-flow optimize topology
```
