...
description: "Migrated source command `training-specialization`"
---

# source-command-training-specialization

Use this skill when the user asks to run the migrated source command `training-specialization`.
...
npx Codex-flow train agent --type coder --capabilities "react,typescript"

# Check specializations
npx Codex-flow agent list --specializations
```
