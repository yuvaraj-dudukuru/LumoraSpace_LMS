---
name: "source-command-swarm-analysis"
description: "Migrated source command `swarm-analysis`"
---

# source-command-swarm-analysis

Use this skill when the user asks to run the migrated source command `swarm-analysis`.
