...
description: "Complete guide to all 87 available agent types in Codex Flow V3"
---

# source-command-agents-agent-types

Use this skill when the user asks to run the migrated source command `agents-agent-types`.

## Command Template

# Agent Types Reference

Complete guide to all 87 available agent types in Codex Flow V3.
...
npx Codex-flow agent spawn --help

# Spawn any agent
npx Codex-flow agent spawn -t <agent-type>
```
